...
export const PinContainer = ({
  ...
  const onMouseEnter = () => {
    // setTransform("translate(-50%,z-50%) rotateX(40deg) scale(0.8)");
  };
  const onMouseLeave = () => {
  ...
  return (
    (<div
      className={cn("relative  z-50  cursor-pointer h-full ", containerClassName)}
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl bg-black border border-white/[0.6] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
